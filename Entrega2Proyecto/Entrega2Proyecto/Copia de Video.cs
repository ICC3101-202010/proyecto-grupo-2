...
namespace ProyectoGrupo2
{
     public class Singer : Person
        ...
        public Actor(List<Video> movies, List<SongClass> songs, List<Disk> disks, List<string> awards, string voiceType, string genders, int yearsActive, List<string> discographic,string name, int age, string lastname, string gender, string nationality, string occupation, List<Video> movies, List<string> awards, int yearsActive)
        {
            this.Name = name;
            this.Age = age;
